...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "jsonc-parser", "vscode-uri", "../utils/strings", "../parser/jsonParser"], factory);
    }
    ...
    var JSONSchemaService = /** @class */ (function () {
        ...
        JSONSchemaService.prototype.loadSchema = function (url) {
            if (!this.requestService) {
                var errorMessage = "Unable to load schema from '" + toDisplayString(url) + "'. No schema request service available";
            ...
            return this.requestService(url).then(function (content) {
                ...
                var errors = jsonErrors.length ? ["Unable to parse content from '" + toDisplayString(url) + "': Parse error at offset " + jsonErrors[0].offset] : [];
                return new UnresolvedSchema(schemaContent, errors);
            }, function (error) {
                var errorMessage = "Unable to load schema from '" + toDisplayString(url) + "': " + error.toString();
                return new UnresolvedSchema({}, [errorMessage]);
            });
        };
        JSONSchemaService.prototype.resolveSchemaContent = function (schemaToResolve, schemaURL, dependencies) {
            ...
            if (schema.$schema) {
                ...
                if (id === 'http://json-schema.org/draft-03/schema') {
                    return this.promise.resolve(new ResolvedSchema({}, ["Draft-03 schemas are not supported."]));
                }
                else if (id === 'https://json-schema.org/draft/2019-09/schema') {
                    schemaToResolve.errors.push("Draft 2019-09 schemas are not yet fully supported.");
                }
            }
