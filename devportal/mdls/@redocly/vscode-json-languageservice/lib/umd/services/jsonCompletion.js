...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../parser/jsonParser", "jsonc-parser", "../utils/json", "../utils/strings", "../utils/objects", "../jsonLanguageTypes"], factory);
    }
                    ...
                    if (schemaProperties_1) {
                        Object.keys(schemaProperties_1).forEach(function (key) {
                            ...
                            if (typeof propertySchema === 'object' && propertySchema.allOf) {
                                for (var _i = 0, _a = propertySchema.allOf; _i < _a.length; _i++) {
                                    var sub = _a[_i];
                                    if (sub.readOnly) {
                                        readOnly = true;
                                        break;
