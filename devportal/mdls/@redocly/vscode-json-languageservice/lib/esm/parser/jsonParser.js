...
export function parse(textDocument, config) {
    ...
    function _parseArray(parent) {
        ...
        while (scanner.getToken() !== 4 /* CloseBracketToken */ && scanner.getToken() !== 17 /* EOF */) {
            ...
            if (!item) {
                _error('Value expected', ErrorCode.ValueExpected, null, [], [4 /* CloseBracketToken */, 5 /* CommaToken */]);
            }
            else {
    ...
    function _parseProperty(parent, keysSeen) {
        ...
        if (!value) {
            return _error('Value expected', ErrorCode.ValueExpected, node, [], [2 /* CloseBraceToken */, 5 /* CommaToken */]);
        }
    ...
    function _parseObject(parent) {
        ...
        while (scanner.getToken() !== 2 /* CloseBraceToken */ && scanner.getToken() !== 17 /* EOF */) {
            ...
            if (!property) {
                _error('Property expected', ErrorCode.PropertyExpected, null, [], [2 /* CloseBraceToken */, 5 /* CommaToken */]);
            }
            else {
